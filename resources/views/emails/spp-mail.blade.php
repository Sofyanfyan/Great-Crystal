...
<body style="background-color:#f9f0e6;">
    ...
    <div style="background-color:#f9f0e6;">
        ...
        @php
            $checkType =
                $mailData['bill'][0]->type == 'SPP' || strtolower($mailData['bill'][0]->type) == 'shadow teacher'
                    ? true
                    : false;
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        <h1
                                                                            ...
                                                                            {{ $checkType
                                                                                ? $type . ' ' . date('F Y', strtotime($mailData['bill'][0]->deadline_invoice))
                                                                ...
                                                                <td align="left"
                                                                    ...
                                                                    @else
                                                                        <div
                                                                            ...
                                                                            @else
                                                                                <p style="margin: 0;">
                                                                                    {{ 'Kami informasikan tagihan untuk ' .
                                                                                        $mailData['bill'][0]->name .
                                                                                        ' ' .
                                                                                        $dateString .
                                                                                        ' adalah sebagai berikut:' }}
                                                                                </p>
                                                                ...
                                                                <tr>
                                                                    <td align="center"
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <b>Pembayaran setelah tanggal 10 setiap
                                                                                bulannya akan dikenakan denda sebesar
                                                                                Rp.100.000</b>
                                                                        </div>
                                                                    </td>
                                                                </tr>
